...
urlpatterns = [
    ...
    path('beneficiary/<int:beneficiary_id>/', views.get_beneficiary_profile, name='get_beneficiary_profile'),
    path('beneficiary/update/<int:beneficiary_id>/', views.update_beneficiary_profile, name='update_beneficiary'),
